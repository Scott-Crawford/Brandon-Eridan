...
export const site = {
  ...
  bio: [
    ...
    'Brandon’s journey into sewing began out of necessity as much as curiosity, as he had great difficulty finding masculine clothing in his adolescence that fit not only his body but also his aesthetic interests. This experience instilled a strong emphasis on size-inclusivity in his practice and inspired him to develop his own clothing business, specializing in historical- and fantasy-inspired menswear, which he plans to launch in the near future. This business will offer both completed garments and digital sewing patterns, one of which he produced for his capstone project during his final year at CMU.',
    'Brandon is currently employed as a suturist at PECA Labs, a Pittsburgh-based company that creates cardiovascular valves and implants. Outside of costuming, he is an avid writer and is currently working on his first novel. He also collects porcelain jester dolls and hopes to one day create life-sized versions of their costumes for himself to wear.',
  ],
}

export const categories = [
  { slug: 'costumes', label: 'Costumes', blurb: 'Theatre, cosplay, drag, and more' },
  { slug: 'fashion', label: 'Fashion', blurb: 'Original designs, upcycles, and historical inspiration' },
  { slug: 'digital-patterning', label: 'Digital Patterning', blurb: 'Projects created in CLO | 3D' },
]
